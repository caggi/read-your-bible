...
(function () {
  ...
  // Leituras (exemplo: preenchi 1–15 conforme sua imagem; complete 16–31)
  const readings = {
  ...
  const defaultDay =
    now.getMonth() === monthIndex ? now.getDate() : 1;

  // dispara seleção “visual”
...
(function () {
  ...
  chips.forEach(chip => {
    chip.addEventListener("click", () => {
      ...
      badge.textContent = labels[idx] || "MÊS";
    });
  });
})();
...
(function () {
  ...
  if (!calendarView || !tableView || !buttons.length) return;
